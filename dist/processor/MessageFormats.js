...
exports.UpdateFromAddonCall = exports.UpdateFromNewCall = exports.AllCallsMessage = exports.NewMessageFormat = void 0;
let formatter = Intl.NumberFormat('en', { notation: 'compact' });
const NewMessageFormat = (commandDetail, totalCallsCount) => {
    return `
...
exports.NewMessageFormat = NewMessageFormat;
const listoftgcalls = async (commandDetail, logs) => {
    let out = '';
    let cnt = 1;
...
const AllCallsMessage = async (commandDetail, tokenLogs) => {
...
exports.AllCallsMessage = AllCallsMessage;
const UpdateFromNewCall = (commandDetail, totalCallsCount) => {
    return `
    $${commandDetail.tokenSymbol} <b>Call ${totalCallsCount} :</b> <b> <a href="https://t.me/${commandDetail.channelName}/${commandDetail.callerPostId}">${commandDetail.callerTG}</a></b>
...
exports.UpdateFromNewCall = UpdateFromNewCall;
const UpdateFromAddonCall = (commandDetail, totalCallsCount) => {
    return `
$${commandDetail.tokenSymbol} <b>Call ${totalCallsCount} :</b> <b> <a href="https://t.me/${commandDetail.channelName}/${commandDetail.callerPostId}">${commandDetail.callerTG}</a></b>
...
exports.UpdateFromAddonCall = UpdateFromAddonCall;
const getCallCountBalls = (cnt) => {
    let disp = '';
    for (var i = 1; i <= cnt; i++) {
        disp = disp + '🟢';
        if (i % 3 === 0)
